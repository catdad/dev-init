...
Kiril approves of [Brackets](https://github.com/adobe/brackets). So a config file is created to correctly set up Brackets. If you already have this file, the settings will be merged into your existing file.

There is an option here to select your prefered linter:
...
## You mentioned something about some file sbeing skipped?
